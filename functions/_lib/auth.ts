        ...
        if (resendKey) {
          try {
            await fetch('https://api.resend.com/emails', {
              ...
              body: JSON.stringify({
                from: 'Career Hound <support@careerhound-7sx.pages.dev>',
                to: [user.email],
                subject: 'Verify your email address - Career Hound',
                html: `
                  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; padding: 24px; border: 1px solid #e2e8f0; border-radius: 16px;">
                    <h2 style="color: #0f172a; margin-top: 0;">Verify your Career Hound Account</h2>
